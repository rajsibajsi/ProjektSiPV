    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading"><div class="row"><div class="col-sm-10">Users</div><div id="nearMe" style="text-align:right; cursor: pointer;" class="col-sm-2"><span class="glyphicon glyphicon-map-marker"></span>Near me</div></div></div>
...
$(document).ready( function() {
    $("#nearMe").click( function() {
        ...
        for (var i = 0; i < distances.length; i++) {
            if (distances[i] > 50) {
                $(".panel-body > a:nth-child(" + (i + 1) + ")").css("visibility", "hidden");
